...
{
$brid=$_GET['id'];
$res=$mysqli->query("select * from branch where BranchCode='$brid'");
$row=$res->fetch_assoc();
$brancode=$row['BranchCode'];
$branch=$row['Branch'];
}
...
$sql="update branch set BranchCode='$branchcode',Branch='$branch' where BranchCode='$branchcode'";
					 $rs=mysqli_query($mysqli,$sql);
					 if($rs)
					 {
					 

					 header('Location:editbranch.php?id='.$branchcodes.'&&success=1');
					 }
					 else
					 {
					 header('Location:editaccounttype.php?'.$branchcodes.'error=2');
					 }
}
?>
<!DOCTYPE html>
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-bar-chart-o"></i>Edit Branch
                            </li>
                        </ol>
                    </div>
                </div>
 ...
 ?>
            ...
            <label for="label">Branch Code</label>
			<div class="form-group">
			<input type="text" name="branchcode" class="form-control" value="<?php echo $brancode?>">
