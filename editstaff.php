 ...
 ?>
	...
	<div class="form-group">
	   ...
	   <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
	     <input type="text" name="staffid" id="inputStaffId" class="form-control" value="<?php echo $staffid; ?>" placeholder="Staff Id" required readonly />
	 </div>
	 </div> 
	...
	<div class="form-group">
	   <div class="input-group">
	   <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
	     <input type="text" name="fname" id="inputName" class="form-control" value="<?php echo $fname;?>" placeholder="First Name" required />
	 </div>
	 </div>
	...
	<div class="form-group">
	   <div class="input-group">
	   <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
	     <input type="text" name="lname" id="inputName" class="form-control" value="<?php echo $lname?>" placeholder="Last Name" required />
	 </div>
	 </div>
	...
	<div class="form-group">
	   ...
	   <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
	     <input type="date" name="dob" id="inputAge" class="form-control" value="<?php echo $dob ?>" placeholder="Date Of Birth" required />
	 </div>
	 </div>
	...
	<div class="form-group">
	   ...
	   <option value="<?php echo $stafftype ?>"><?php echo $stafftype ?></option>
...
<label for="EnterUsername">Branch</label>
	<div class="form-group">
	   ...
	   <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
	      <?php
			...
			echo "<option value=".$mbranch.">".$mbranch."</option>";
			$branch = $_POST['branch'];
	...
	<div class="form-group">
	   ...
	   <span class="input-group-addon"><span class="glyphicon glyphicon-phone"></span></span>
	     <input type="number" name="mobile" id="mobile" maxlength="10" value="<?php echo $mobile ?>" class="form-control" placeholder="Mobile Number" required />
	 </div>
	 </div>
	...
	<div class="form-group">
	   ...
	   <span class="input-group-addon"><span class="glyphicon glyphicon-send"></span></span>
	     <input type="text" name="addr" id="inputAddress" value="<?php echo $addr?>" class="form-control" placeholder="Post Address" required />
	 </div>
	 </div>
	...
	<div class="form-group">
	   <div class="input-group">
	   <span class="input-group-addon"><span class="glyphicon glyphicon-send"></span></span>
	     <input type="text" name="resaddr" id="inputresAddress" value="<?php echo $resaddr?>" class="form-control" placeholder="Residential Address" required />
	 </div>
	 </div>
	...
	<div class="form-group">
	   ...
	   <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
	     <input type="email" name="email" id="inputEmail" class="form-control" value="<?php echo $email ?>" placeholder="Email" required />
	 </div>
	 </div>
	 <div class="modal-footer">
	<button type="submit" name="btnupdate" class="btn btn-primary"><span class="glyphicon glyphicon-save"></span> Save Changes</button>
	</div>
                              </form>
                            </div>
                        </div>
