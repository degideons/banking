...
$res=$mysqli->query("select * from customeraccount a,customerinfo c,branch b where a.CustomerNumber=c.CustomerNumber and a.BranchCode=b.BranchCode and a.AccStatus='Active' and a.AccountTypeCode='101' and a.AccountNumber='$txtsearch'");
}
else
{
$res=$mysqli->query("select * from customeraccount a,customerinfo c,branch b where a.CustomerNumber=c.CustomerNumber and a.BranchCode=b.BranchCode and a.AccStatus='Active' and a.AccountTypeCode='101'");
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Customer Enquiry
                            </li>
                        </ol>
                    </div>
                </div>
