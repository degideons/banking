...
$res=$mysqli->query("Select * from customeraccount a,transaction t where 
					 a.AccountNumber=t.AccountNumber and a.AccountNumber='$accountnumber' order by t.TransactDate,t.TransactTime desc");
$row=$res->fetch_assoc();
$balance=$row['Balance'];
}
?>
                    ...
                    <div class="col-lg-12">
                       ...
                       Balance Enquiry
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-money"></i> Balance Enquiry
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<div class="col-lg-1"></div>
                    <div class="col-lg-10">
                        <div class="panel panel-primary">
							...
							<tr>
<td></td>
<td><input type="text" name='accountnumber' value="<?php echo $accountnumber ?>" placeholder="Please Input Account Number" class="form-control" required></td>
<td>
<button type="submit" name="btnsearch" class="btn btn-primary"><span class="fa fa-search"></span> Search</button>
</td>
</tr>
<tr>
<td><label for="label">Balance $</label></td>
<td> 
<div class="form-group">
<input type="text" name="balance" value="<?php echo $balance?>" placeholder="Balance" readonly class="form-control" required>
</div>
</td>
</tr>
