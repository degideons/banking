...
$res=$mysqli->query("select * from customeraccount a,customerinfo c where a.CustomerNumber=c.CustomerNumber and a.AccStatus='Active' and a.AccountNumber='$txtsearch'");
}
else
{
$res=$mysqli->query("select * from customeraccount a,customerinfo c where a.CustomerNumber=c.CustomerNumber and a.AccStatus='Active'");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<td><label for="label">Marital Status</label></td>
<td><label for="label">Occupation</label></td>
<td><label for="label">Residential Address</label></td>
<td><label for="label">Email</label></td>
<td><label for="label">Telephone</label></td>
<td><label for="label">Legal ID</label></td>
<td><label for="label">ID Number</label></td>
</tr>
<?php 
