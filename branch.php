...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-table"></i> Branches
                            </li>
                        </ol>
                    </div>
                </div>
 ...
 ?>
             ...
             <table class="table">
			 <tr>
			 <td><button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#mymodal">Add New Branch <span class="glyphicon glyphicon-plus-sign"></span></button></td>
			  <td><input type="text" class="form-control" name="txtsearch" value="<?php echo $txtsearch?>" placeholder="Input Branch Code To Search"></td>
		  ...
		  <table class="table">
			 ...
			 <th><label for="">Branch Code</label></th>
			 <th><label for="">Branch</label></th>
			 </tr>
			 </thead>
			 <?php 
			 $no=1;
			 ...
			 <td><?php echo $row['Branch']?></td>
			  <td>
			 <a href="editbranch.php?id=<?php echo $row['BranchCode']?>" class="btn btn-warning" data-toggle="tooltip" title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
			 <a href="deletebranch.php?id=<?php echo $row['BranchCode']?>" class="btn btn-danger" data-toggle="tooltip" title="Delete"><span class="glyphicon glyphicon-trash"></span></a>
			 </td>
